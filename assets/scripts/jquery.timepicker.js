...
(function (factory) {
	...
	var methods = {
		init: function(options)
		{
			return this.each(function()
			{
				...
				self.addClass('ui-timepicker-input'); //mcd - add some EDS class here
		...
		remove: function()
		{
			...
			self.removeClass('ui-timepicker-input'); //mcd - remove EDS class here
	...
	function _render(self)
	{
		...
		if (settings.useSelect) {
			...
			list = $('<ul />', { 'class': 'ui-timepicker-list esg-dropdown__menu' });

			var wrapped_list = $('<div />', { 'class': 'ui-timepicker-wrapper', 'tabindex': -1 });
			wrapped_list.css({'display':'none', 'position': 'absolute', 'width':'14em', 'height':'300px' }).append(list);
		}
        ...
        row.addClass('esg-dropdown__menu-item'); //mcd - added this
